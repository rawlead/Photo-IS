	...
	MsgPop.open = function(obj){
		...
		switch (obj.Type) {
			case "success":
				...
				obj.Icon = (obj.Icon == null) ? '<i class="fas fa-star"></i>' : obj.Icon;
				break;
			case "error":
				msg.setAttribute('class', 'msgPopError ' + obj.CssClass);
				obj.Icon = (obj.Icon == null) ? '<i class="fas fa-trash"></i>' : obj.Icon;
				break;
			case "warning":
				msg.setAttribute('class', 'msgPopWarning ' + obj.CssClass);
				obj.Icon = (obj.Icon == null) ? '<i class="far fa-star"></i>' : obj.Icon;
				break;
			case "message":
				msg.setAttribute('class', 'msgPopMessage ' + obj.CssClass);
				obj.Icon = (obj.Icon == null) ? '<i class="fas fa-camera"></i>' : obj.Icon;
				break;
			default:
				msg.setAttribute('class', 'msgPopMessage ' + obj.CssClass);
